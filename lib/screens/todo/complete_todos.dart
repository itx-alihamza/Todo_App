...
class _CompleteTodosState extends State<CompleteTodos> {
  List<Todo> completedTodos = []; // Changed to specifically store completed todos
  ...
  Future<void> _loadCompletedTodos() async {
    try {
      ...
      List<Todo> completed = allTodos.where((todo) => todo.isCompleted).toList();
                                  ...
                                  children: [ 
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontSize: 20,
                                        decoration: TextDecoration.lineThrough, // Show completed with strikethrough
